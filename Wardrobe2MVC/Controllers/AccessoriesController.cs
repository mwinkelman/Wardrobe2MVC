...
namespace Wardrobe2MVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Nickname,PhotoURL,Type,Color,Season,Occasion")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Nickname,PhotoURL,Type,Color,Season,Occasion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
